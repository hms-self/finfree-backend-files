...
with open ('2009 sanai 3.csv' ,'r', encoding='utf-8-sig') as reader_file1:
    with open('2009 sanai 6.csv', 'r', encoding='utf-8-sig') as reader_file2:
        with open('2009 sanai 9.csv', 'r', encoding='utf-8-sig') as reader_file3:
            with open('2009 sanai 12.csv', 'r', encoding='utf-8-sig') as reader_file4:
                with open('2010 sanai 3.csv', 'r', encoding='utf-8-sig') as reader_file5:
                    with open('2010 sanai 6.csv', 'r', encoding='utf-8-sig') as reader_file6:
                        with open('2010 sanai 9.csv', 'r', encoding='utf-8-sig') as reader_file7:
                            with open('2010 sanai 12.csv', 'r', encoding='utf-8-sig') as reader_file8:
                                with open('2011 sanai 3.csv', 'r', encoding='utf-8-sig') as reader_file9:
                                    with open('2011 sanai 6.csv', 'r', encoding='utf-8-sig') as reader_file10:
                                        with open('2011 sanai 9.csv', 'r', encoding='utf-8-sig') as reader_file11:
                                            with open('2011 sanai 12.csv', 'r', encoding='utf-8-sig') as reader_file12:
                                                with open('2012 sanai 3.csv', 'r',
                                                          encoding='utf-8-sig') as reader_file13:
                                                    with open('2012 sanai 6.csv', 'r',
                                                              encoding='utf-8-sig') as reader_file14:
                                                        with open('2012 sanai 9.csv', 'r',
