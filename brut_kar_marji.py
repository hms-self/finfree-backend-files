import csv
import os
with open ('2016 sanai 9.csv' ,'r', encoding='utf-8-sig') as reader_file1:
    with open('2016 sanai 12.csv', 'r', encoding='utf-8-sig') as reader_file2:
        with open('2017 sanai 3.csv', 'r', encoding='utf-8-sig') as reader_file3:
            with open('2017 sanai 6.csv', 'r', encoding='utf-8-sig') as reader_file4:
                with open('2017 sanai 9.csv', 'r', encoding='utf-8-sig') as reader_file5:
                    with open('2017 sanai 12.csv', 'r', encoding='utf-8-sig') as reader_file6:
                        with open('2018 sanai 3.csv', 'r', encoding='utf-8-sig') as reader_file7:
                            with open('2018 sanai 6.csv', 'r', encoding='utf-8-sig') as reader_file8:
                                with open('2018 sanai 9.csv', 'r', encoding='utf-8-sig') as reader_file9:
                                    with open('2018 sanai 12.csv', 'r', encoding='utf-8-sig') as reader_file10:
                                        with open('2019 sanai 3.csv', 'r', encoding='utf-8-sig') as reader_file11:
                                            with open('2019 sanai 6.csv', 'r', encoding='utf-8-sig') as reader_file12:
                                                with open('2019 sanai 9.csv', 'r',
                                                          encoding='utf-8-sig') as reader_file13:
                                                    with open('2019 sanai 12.csv', 'r',
                                                              encoding='utf-8-sig') as reader_file14:
                                                        with open('2020 sanai 3.csv', 'r',
                                                                ...
                                                                with open('new_yes.csv', 'r') as p_file: #bir öncekini oku
                                                                    with open('new_yes1.csv', 'w') as n_file: #üstüne yeni columnlar ekle
                                                                        ...
                                                                        for k in range(15):
                                                                             for j in range(1,351): #brüt kar marjı
                                                                                try:
                                                                                    brut_kar_marji=round( (1-(float(all[k][328][j].replace('.','').replace(',','.')[:-3])/(float(all[k][315][j].replace('.','').replace(',','.')[:-3]))))*100,2)

                                                                                except ZeroDivisionError:
                                                                                    brut_kar_marji=0
                                                                                lists[j].extend(['%'+str(brut_kar_marji)])
